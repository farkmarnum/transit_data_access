...
DB_SERVER_IP = '127.0.0.1' # this would be changed to the IP of the db server if separate
DB_SERVER_WEBSOCKET_PORT = 65432

WEB_SERVER_IP = '127.0.0.1' # this stays as localhost since NGINX is passing requests to localhost
