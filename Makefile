...
ECR := $(AWS_ID).dkr.ecr.us-east-1.amazonaws.com/transit-data-access
...
push:
	docker tag transit_data_access/parser:latest $(AWS_ID).dkr.ecr.us-east-1.amazonaws.com/transit-data-access/parser:latest \
	&& docker tag transit_data_access/web_client:latest $(AWS_ID).dkr.ecr.us-east-1.amazonaws.com/transit-data-access/web_client:latest \
	&& docker tag transit_data_access/web_server:latest $(AWS_ID).dkr.ecr.us-east-1.amazonaws.com/transit-data-access/web_server:latest \
	&& docker push $(AWS_ID).dkr.ecr.us-east-1.amazonaws.com/transit-data-access/parser:latest \
	&& docker push $(AWS_ID).dkr.ecr.us-east-1.amazonaws.com/transit-data-access/web_server:latest \
	&& docker push $(AWS_ID).dkr.ecr.us-east-1.amazonaws.com/transit-data-access/web_client:latest \
